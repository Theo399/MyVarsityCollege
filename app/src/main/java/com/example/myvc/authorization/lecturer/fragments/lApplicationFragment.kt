...
class lApplicationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_l_application, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myWebView.loadUrl("https://forms.office.com/r/6sz9dMewDM")
