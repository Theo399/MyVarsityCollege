...
class sAssessmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_s_assessment, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myWebView.loadUrl("https://classroom.google.com/a/not-turned-in/all")
