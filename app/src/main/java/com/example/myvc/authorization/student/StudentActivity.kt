...
import com.example.myvc.authorization.student.fragments.sTimeTableFragment
...
class StudentActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId) {
            ...
            R.id.nav_s_timetables -> supportFragmentManager.beginTransaction()
                .replace(R.id.frameLayout, sTimeTableFragment()).commit()
            ...
            //R.id.nav_s_application -> startActivity(Intent(this@StudentActivity, sExtensionActivity::class.java))
            R.id.nav_s_status -> supportFragmentManager.beginTransaction()
                .replace(R.id.frameLayout, sStatusFragment()).commit()
            //R.id.nav_s_status -> startActivity(Intent(this@StudentActivity, sTraceActivity::class.java))
